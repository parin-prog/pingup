...
import { assets, dummyPostsData, type PostType } from "../assets/assets";
...
const Feed = () => {
  ...
  return !loading ? (
    <div className="h-full overflow-y-scroll bo-scrollbar py-10
     xl:pr-5 flex items-start justify-center xl:gap-8">
      ...
      <div className="max-xl:hidden sticky top-0">
        ...
        flex-col gap-2 shadow">
          ...
          <p className="">Supercharge your marketing with a powerful, easy-to-use
