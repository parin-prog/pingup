...
const CreatePost = () => {
  ...
  return <div className="min-h-screen bg-linear-to-b from-slate-50 to-white">
    <div className="max-w-6xl mx-auto p-6">
      ...
      {/* Form */}
      <div className="max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl
      shadow-md space-y-4">
        {/* Header */}
        <div>
          <img src={user.profile_picture} className="w-12 h-12
          rounded-full shadow" alt="" />
            ...
            {images.map((image, i) => (
              <div key={i} className="relative group">
                ...
                <div onClick={() => setImages(images.filter((_, index) =>
                  index !== i))} className="absolute hiddden group-hover:flex
                justify-center items-center top-0 right-0 bottom-0 left-0
                bg-black/40 roundedd-md cursor-pointer">
