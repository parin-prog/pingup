...
import type { PostType, UserType } from "../assets/assets"
...
const UserProfileInfo = ({ user, posts, profileId, setShowEdit }: UserInfoProps) => {
	return (
		<div className="relative py-4 px-6 md:px-8 bg-white">
			<div className="flex flex-col md:flex-row items-start gap-6">
				<div className="w-32 h-32 border-4 border-white shadow-lg absolute
				-top-16 rounded-full">
					<img src={user.profile_picture} alt="" className="w-full h-full
				object-cover rounded-full z-2" />
				</div>
				...
				{!profileId && (
					<button onClick={() => setShowEdit(true)} className="flex items-center gap-2 cursor-pointer border
