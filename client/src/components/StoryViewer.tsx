...
import type { StoryType } from "../assets/assets";

const StoryViewer = ({ viewStory, setViewStory }: {
	viewStory: StoryType, setViewStory: React.Dispatch<React.SetStateAction<StoryType | null>>
}) => {
	...
	return (
		...
		items-center justify-center" style={{
			...
			sm:p-4 sm:px-8 backdrop-blur-2xl rounded bg-black/50">
				...
				sm:size-8 roundedd-full object-cover border border-white" />
